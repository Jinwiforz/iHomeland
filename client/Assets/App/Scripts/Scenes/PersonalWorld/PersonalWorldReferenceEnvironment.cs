...
namespace IHomeland.Client.Scenes.PersonalWorld
{
    ...
    public sealed class PersonalWorldReferenceEnvironment : MonoBehaviour
    {
        ...
        private const int GroundHalfExtentMeters = 25;
        ...
        /// <summary>创建两条主轴与不对称高度地标的单Mesh。</summary>
        /// <returns>帮助判断方向、速度与视差的地标Mesh。</returns>
