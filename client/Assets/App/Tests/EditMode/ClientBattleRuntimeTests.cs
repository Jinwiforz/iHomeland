...
namespace IHomeland.Client.Tests.EditMode
{
    ...
    public sealed class ClientBattleRuntimeTests
    {
        ...
        public void InputProtocolPreservesClosedOptionalFieldShape()
        {
            ...
            Assert.That(decoded.Commands, Has.Count.EqualTo(6));
        ...
        public void PredictionPacesAheadClockAtAuthorityHorizon()
        {
            ...
            var resumed =
                network.Bundles[network.Bundles.Count - 1];
            Assert.That(network.Bundles, Has.Count.EqualTo(4));
            Assert.That(
        ...
        /// <summary>
        /// 确认同actor successor从full baseline继承authority ack锚点，而不继承旧预测历史。
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// 确认current平地预测复现server百万分比crossing与toward-zero整数落点。
        /// </summary>
        [Test]
        ...
        public void ProjectorSeparatesActorSourcesAndMapsStartedCueToImpulse()
        {
            ...
            Assert.That(presentation.Cues[0].AbilityID, Is.EqualTo(42));
