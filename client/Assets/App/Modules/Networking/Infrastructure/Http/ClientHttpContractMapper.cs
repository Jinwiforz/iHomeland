...
{
    /// <summary>
    /// 显式编码本阶段请求，并把不可信 HTTP JSON 转换为不可变 Application contract。
    /// </summary>
    /// <remarks>
    /// Mapper 不使用 reflection DTO，避免 IL2CPP metadata 依赖。未知 response property 被忽略以容纳
    /// additive 演进，但当前版本的 required field、enum、范围和集合上限必须全部通过验证。
    /// </remarks>
    internal sealed class ClientHttpContractMapper
    {
        /// <summary>
