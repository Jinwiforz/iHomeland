...
namespace IHomeland.Client.AppShell.Tests.EditMode
{
    ...
    public sealed class BaselineConfigurationTests
    {
        ...
        /// </summary>
        private const string PersonalWorldScenePath =
        ...
        private const string WorldHudPrefabPath =
            "Assets/App/Modules/PersonalWorld/Content/UI/Prefabs/WorldHud.prefab";

        /// <summary>
        /// 定义唯一项目 Input System 资产的稳定路径。
        /// </summary>
        private const string InputActionsPath =
            "Assets/App/Modules/Core/Content/Input/InputSystem_Actions.inputactions";
        ...
        {
            "Assets/App/Modules/PersonalWorld/Content/UI/LoginView.uxml",
            "Assets/App/Modules/PersonalWorld/Content/UI/ShellView.uxml",
            "Assets/App/Modules/PersonalWorld/Content/UI/WorldVisitView.uxml",
            "Assets/App/Modules/PersonalWorld/Content/UI/ConnectionLostView.uxml",
        };
        ...
        public void ProductScenesKeepSingleOwnersAndCompleteHostReferences()
        {
            ...
            try
            {
                ...
                contexts[0].ValidateBattleConfiguration();
        ...
        /// <summary>
        /// 验证 Unity 源资产保持 ForceText，且项目自有功能模块没有 Resources 目录。
        /// </summary>
        [Test]
        public void AssetSerializationAndResourceBoundaryStayExplicit()
        {
            ...
            var resourcesDirectories = Directory.GetDirectories(
                Path.Combine(UnityEngine.Application.dataPath, "App", "Modules"),
                "Resources",
        ...
        public void RepositoryIgnoreRulesProtectGeneratedAndLocalState()
        {
            ...
            Assert.That(gitIgnore, Does.Not.Contain("/client/Assets/App/Modules/"));
            Assert.That(gitIgnore, Does.Not.Contain("/client/Assets/App/Assemblies/"));
        }
