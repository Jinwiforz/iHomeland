...
namespace IHomeland.Client.PersonalWorld.Presentation
{
        ...
        IPersonalWorldSceneTransactionHost
    {
        ...
        /// <summary>
        /// 撤销 Experience 拥有的 intent、subscriber 与 generation，阻止迟到回写复活页面。
        /// </summary>
        /// <remarks>
        /// Active/cached route、Host、focus 与 input mode 由唯一 ClientUiRouter 在其 Stop 中清理。
        /// Experience 不在 AppLifetime 逆序停止时创建第二条 route transition 链。
        /// </remarks>
