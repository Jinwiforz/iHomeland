...
当前进程已开放 world bootstrap、invite accept、admission issue、WSS control 与 TLS/TCP world/visit route；本竖切只承载 PersonalWorld/VisitSession 访问控制和 snapshot，不包含地图、任务、奖励或其他未登记 world mutation。这些能力必须继续遵守 `docs/roadmap.md` 的进入条件，由后续独立 change 实现和验收。
