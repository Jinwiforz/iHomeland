...
func TestCatalogIsContinuousAndSingleStatement(t *testing.T) {
	...
	expectedNames := []string{"initialize_schema_history", "create_personal_worlds", "create_personal_world_idempotency", "create_placement_sequences", "create_placement_allocations", "create_accounts", "create_simulation_result_receipts"}
