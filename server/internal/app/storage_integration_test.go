...
`, binaryPath, integrationArtifactDigest(t, binaryPath), receiptPath, integrationArtifactDigest(t, receiptPath), integrationBuildIdentity(t, identityPath), strings.ReplaceAll(packageRoot, "'", "''"), strings.ReplaceAll(arenaRoot, "'", "''"))
}
