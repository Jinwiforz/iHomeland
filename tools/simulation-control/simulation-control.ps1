...
function Assert-ControlFrame {
    ...
    $payloadAllowed = @{
        ...
        "node.hello.challenge" = @("simulationNodeId", "runtimeNodeId", "expectedBuildIdentity", "expectedConfigIdentity", "expectedModelManifest", "expectedNavigationIdentity", "expectedPhysicsIdentity", "expectedProfileManifest", "expectedWireIdentity", "instanceCapacity", "actorCapacity")
        "node.hello.receipt" = @("simulationNodeId", "runtimeNodeId", "buildIdentity", "configIdentity", "gameplayPackageId", "mappingIdentity", "modelManifest", "navigationIdentity", "physicsIdentity", "profileManifest", "wireIdentity", "platformQualification", "instanceCapacity", "actorCapacity")
